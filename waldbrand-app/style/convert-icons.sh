...
SvgToBvg "$MARKERS/hydrant-template.svg" "$DIR/default/symbols/hydrant-template.bvg"
...
SvgToBvg "$MARKERS/rettungspunkt.svg" "$DIR/default/symbols/rettungspunkt.bvg"
