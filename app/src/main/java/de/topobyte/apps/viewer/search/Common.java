...
public class Common
{
  ...
  public static final String PREF_SEARCH_QUERY = "query:search";
  public static final String PREF_SEARCH_QUERY_EXACT = "query:search:exact";
  public static final String PREF_SEARCH_QUERY_ORDER = "query:search:order";
